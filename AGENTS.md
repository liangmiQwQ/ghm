...
You can use some format for output, like red / red background for errors. But don't use too much color or format. Keep it simple and clean. Should always use `cac` for cli command parsing and `picocolors` for output formatting.
